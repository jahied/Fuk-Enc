# Decompile by (BLACK HUNTER TEAM)
...
\033[1;94m  _    _ _    _ _   _ _______ ______ _____  
 | |  | | |  | | \ | |__   __|  ____|  __ \ 
 | |__| | |  | |  \| |  | |  | |__  | |__) |
 |  __  | |  | | . ` |  | |  |  __| |  _  / 
 | |  | | |__| | |\  |  | |  | |____| | \ \ 
...
\033[1;92m  _______ ______          __  __ 
 |__   __|  ____|   /\   |  \/  |
    | |  | |__     /  \  | \  / |
    | |  |  __|   / /\ \ | |\/| |
    | |  | |____ / ____ \| |  | |
...
\033[43m\033[1;91m[Programmed By BD JAHIED ]
\033[43m\033[1;91m[WhatsApp : +8801747951169 ]
\033[43m\033[1;91m[Facebook : Bd Jahied ]
\033[43m\033[1;91m[Team : BLACK HUNTER TEAM ]
...
#def about():
    ...
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[BD JAHIED] ')
    print(yellow+'║'+cyan+'[ Github ]    '+purple+' :[https://github.com/BLACK-HUNTER-TEAM] ')
    print(cyan+'║[Messenger] '+purple+' :[https://m.me/ROOT.OFF.JAHIED]')
    print(cyan+'║[Email]     '+purple+' :[jahiedislam1991@gmail.com]\n')
    print('\n[01] Main Menu')
    print('[02] Exit')
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view https://www.facebook.com/ROOT.OFF.JAHIED')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()    
   #         else:
    #   os.system('xdg-open https://www.facebook.com/ROOT.OFF.JAHIED')
